...
import { StyleSheet, Text, View,Image,ImageBackground,Dimensions, Platform, PixelRatio,Linking,Alert,TouchableWithoutFeedback, TouchableOpacity} from 'react-native';
    ...
    render = () => {
        ...
        return (
            ...
            <Header
                ...
                centerComponent={{ text: 'SS TV Ranipet', style: { color: '#fff',fontSize:normalize(18)} }}
            ...
            />
                ...
                swipeDirection="right" isVisible={this.state.isinfo} style={{marginTop :"50%" ,backgroundColor:'white',maxHeight:Dimensions.get('window').height/3}}>
                    <AntDesign name="closecircle" size={normalize(24)} color="red" style = {{position:"absolute",top:10,right:5}} onPress={()=>this.setState({isinfo: false})}/>
                        <View style = {{alignItems:'center'}}>
                        <Text style = {{fontSize:normalize(18),color:"#fc3d3d",fontWeight:"bold",}}>SS TV WALAJA NETWORK</Text>
                        <Text style = {{fontSize:normalize(13),color:"#e770ff"}}>No:23, Nethaji street,Walajapet,Vellore</Text>
                        </View>
                </Modal>   
                <View style = {styles.Bottom}>
                    <View style = {{flexDirection:"row",backgroundColor:"#fff",padding:20}}>
                        ...
                        <View style = {{flex:1,alignItems:"center",justifyContent:"center"}}>
                        <Entypo name="facebook-with-circle" size={normalize(45)} color="#0080ff" onPress = {() =>{Linking.openURL('fb://page/105016241207647');}}/>
                        <Text style = {styles.txtstylesocial}>Facebook</Text>  
                        </View>
                        <View style = {{flex:1,alignItems:"center",justifyContent:"center"}}>
                        <MaterialCommunityIcons name="google-maps" size={normalize(45)}  color="#37a670" onPress = {this.location}/>
                        <Text style = {styles.txtstylesocial}>Location</Text>    
                        </View>
                        <View style = {{flex:1,alignItems:"center",justifyContent:"center"}}>
                        <Ionicons name="md-call" size={45} color="#0080ff" onPress={this.showAlert.bind(this,'7339003295','SS MEDIA NETWORK')}/>
                    ...
                    <View style = {{backgroundColor:"white",paddingVertical:20,width:"100%",justifyContent:"center",alignItems:"center",elevation:10,borderTopWidth:.5,borderTopColor:'#5c5c5c'}}>
                        <Text style = {{fontSize:normalize(16),color:"#fc3d3d",fontWeight:"bold"}}>SS TV WALAJA NETWORK</Text>
                        <Text style = {{fontSize:normalize(13),color:"#e770ff"}}>For Advertisements : 7339003295</Text>
                        <Text style = {{fontSize:normalize(13),color:"#e770ff"}}>No:23, Nethaji street,Walajapet,Vellore</Text>
                    </View>
                    <View style = {{backgroundColor:"#4aa4ff",flexDirection:"row",paddingHorizontal:10,paddingVertical:20,width:"100%",justifyContent:"center",alignItems:"center"}}>
                        <View style = {{borderRightColor:"black",borderRightWidth:1,paddingRight : 10}}>
                        <View style = {{flexDirection:"row",alignItems:"center"}} >
                            <Ionicons name="md-call" size={normalize(10)} color="white" style = {{paddingRight:5}}/>
                        ...
                        <View style = {{flexDirection:"row",alignItems:"center"}} >
                            <Ionicons name="md-mail" size={normalize(10)} color="white" style = {{paddingRight:5}}/>
                            <Text style = {styles.txtcall}>sstvwalaja@gmail.com</Text>
                        </View>
                        <View style = {{flexDirection:"row",alignItems:"center"}} >
                            <Entypo name="network" size={normalize(10)} color="white" style = {{paddingRight:5}}/>
